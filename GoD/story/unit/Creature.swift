...
struct Minions {
    ...
    static let data = [
        ...
        Creature.WasteWalker: Minions(
            ...
            name: "荒地行者",
            race: EvilType.RISEN,
            settingGrowth: Mains(stamina: 2.1, strength: 2.1, agility: 1, intellect: 0.4),
        ...
        Creature.SnowLady: Minions(
            ...
            name: "冰雪女妖",
            race: EvilType.MAN,
            settingGrowth: Mains(stamina: 1.3, strength: 1.6, agility: 2.4, intellect: 0.5),
        ...
        Creature.BloodBat: Minions(
            ...
            name: "血色蝙蝠",
            race: EvilType.NATURE,
            settingGrowth: Mains(stamina: 1.6, strength: 1.1, agility: 1.9, intellect: 0.9),
        ...
        Creature.EvilSpirit: Minions(
            ...
            name: "邪灵",
            race: EvilType.RISEN,
            settingGrowth: Mains(stamina: 1.2, strength: 0.5, agility: 0.8, intellect: 2.9),
