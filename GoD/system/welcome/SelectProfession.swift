...
class SelecProfession:UIPanel {
    ...
    override func create() {
        ...
        _infos = [
            ...
            ["傀儡师", "成为一名儡师，你将会获得4点属性成长、可同时使用3个技能、可配置3个随从跟随战斗，并且可以装备武器、饰品、灵魂石和左右法戒。", 4, true, false, false, 3, 3, [LowerSummon()]],
            ["神使", "成为一名神使，你将会获得5点属性成长、可同时使用3个技能、可配置2个随从跟随战斗，并且可以装备盾牌、饰品、魔印、灵魂石和左右法戒。", 5, false, true, true, 2, 3, [Heal()]],
