...
class MinionsHouseInside: UIScene {
    ...
    override func create() {
        ...
        addSingleCellItem(x: 0, line: 3, texture: Game.instance.inside_b.getCell(0, 11, 1, 2))
        addSingleCellItem(x: 2, line: 5.25, texture: Game.instance.inside_b.getCell(0, 3, 1, 2))
        addSingleCellItem(x: 1, line: 3, texture: Game.instance.inside_c.getCell(2, 11))
        addSingleCellItem(x: 6, line: 4.5, texture: Game.instance.inside_c.getCell(9, 1))
        addSingleCellItem(x: 3, line: 3, texture: Game.instance.inside_c.getCell(2, 13))
        addSingleCellItem(x: 8, line: 4, texture: Game.instance.inside_b.getCell(2, 7, 1, 2))
        let pc8 = Game.instance.pictureCollabo8_1

        addSingleCellItem(x: 3, line: 2.5, texture: pc8.getCell(4, 0), z: UIStage.LAYER2 + 1)
        addSingleCellItem(x: 2, line: 2.5, texture: Game.instance.pictureNature.getCell(4, 0), z: UIStage.LAYER2 + 1)
...
//        let char = Data.instance._char!
        if stage.isUpperPoint {
            ...
            if 3 == pos && !stage._dialogExist {
                let img = Game.instance.pictureCollabo8_1.getCell(4, 0)
                ...
                let img = Game.instance.pictureCollabo8_1.getCell(1, 0)
