...
class AdventurersUnionInside: UIScene {
    override init(texture: SKTexture?, color: UIColor, size: CGSize) {
        ...
        let oa4 = Game.instance.inside_a4
    ...
    override func create() {
        ...
        createTopWall()
        let tile_innerTown = Game.instance.tile_innerTown
        let inside_c = Game.instance.inside_c
        let inside_b = Game.instance.inside_b
...
//        position.x = -cellSize * 3
        ...
        let ia5 = Game.instance.inside_a5
        ...
        addSingleCellItem(x: 4, line: 3, texture: Game.instance.pictureBaldo.getCell(10, 0))
        addSingleCellItem(x: 8, line: 3, texture: Game.instance.pictureEvil.getCell(1, 0))
        addSingleCellItem(x: 12, line: 3, texture: Game.instance.pictureEvil.getCell(7, 0))
...
//        let this = self
        if stage.isUpperPoint {
            ...
            if 4 == pos && !stage._dialogExist {
                let img = Game.instance.pictureBaldo.getCell(10, 0)
                ...
                dlg._confirmAction = {
                    ...
                    pep.create()
                    Game.instance.stage.addPanelDefault(p: pep)
                }
            } else if 8 == pos && !stage._dialogExist {
                let img = Game.instance.pictureEvil.getCell(1, 0)
                ...
                let img = Game.instance.pictureEvil.getCell(7, 0)
...
class KnightMaster:CareerMaster {
    override init(texture: SKTexture?, color: UIColor, size: CGSize) {
        super.init(texture: texture, color: color, size: size)
        _img = Game.instance.pictureCollabo8_1.getCell(7, 0)
////        setTexture(_img)
...
class SealMaster:CareerMaster {
    override init(texture: SKTexture?, color: UIColor, size: CGSize) {
        super.init(texture: texture, color: color, size: size)
        _img = Game.instance.pictureAll.getCell(4, 4)
//        let shadow = SKSpriteNode(texture: SKTexture(imageNamed: "select.png").getCell(3, 0))
//        shadow.position.y = -cellSize * 0.25
//        addChild(shadow)
//        let inode = SKSpriteNode(texture: _img)
...
class ArchBishop:CareerMaster {
    override init(texture: SKTexture?, color: UIColor, size: CGSize) {
        super.init(texture: texture, color: color, size: size)
        _img = Game.instance.picturePeople2.getCell(7, 0)
//        let shadow = SKSpriteNode(texture: SKTexture(imageNamed: "select.png").getCell(3, 0))
//        shadow.position.y = -cellSize * 0.25
//        addChild(shadow)
//        let inode = SKSpriteNode(texture: _img)
...
class ArchMage:CareerMaster {
    override init(texture: SKTexture?, color: UIColor, size: CGSize) {
        super.init(texture: texture, color: color, size: size)
        _img = Game.instance.pictureAll2.getCell(7, 4)
//        let shadow = SKSpriteNode(texture: SKTexture(imageNamed: "select.png").getCell(3, 0))
//        shadow.position.y = -cellSize * 0.25
//        addChild(shadow)
//        let inode = SKSpriteNode(texture: _img)
...
class TheBurglar:CareerMaster {
    override init(texture: SKTexture?, color: UIColor, size: CGSize) {
        super.init(texture: texture, color: color, size: size)
        _img = Game.instance.pictureActor1.getCell(1, 4)
//        let shadow = SKSpriteNode(texture: SKTexture(imageNamed: "select.png").getCell(3, 0))
//        shadow.position.y = -cellSize * 0.25
//        addChild(shadow)
//        let inode = SKSpriteNode(texture: _img)
...
class MonkMaster:CareerMaster {
    override init(texture: SKTexture?, color: UIColor, size: CGSize) {
        super.init(texture: texture, color: color, size: size)
        _img = Game.instance.pictureAll.getCell(4, 0)
//        let shadow = SKSpriteNode(texture: SKTexture(imageNamed: "select.png").getCell(3, 0))
//        shadow.position.y = -cellSize * 0.25
//        addChild(shadow)
//        let inode = SKSpriteNode(texture: _img)
...
class HotelHouseDoor:UIItem {
    override init(texture: SKTexture?, color: UIColor, size: CGSize) {
        super.init(texture: texture, color: color, size: size)
        let item = Game.instance.tilee_outsidetown.getCell(1, 14, 1, 1.25)
...
class SingleRoom:UIScene {
    ...
    override func create() {
        ...
        let to = Game.instance.tilee_outsidetown
...
class KnightsRoom:SingleRoom {
    ...
    override func create() {
        super.create()
        addSingleCellItem(x: 4, line: 2.25, texture: Game.instance.pictureCollabo8_1.getCell(7, 0), z:UIStage.LAYER2 + 2)
...
class MagesRoom:SingleRoom {
    ...
    override func create() {
        super.create()
        addSingleCellItem(x: 4, line: 2.25, texture: Game.instance.pictureAll2.getCell(7, 4), z:UIStage.LAYER2 + 2)
...
class BishopsRoom:SingleRoom {
    ...
    override func create() {
        super.create()
        addSingleCellItem(x: 4, line: 2.25, texture: Game.instance.picturePeople2.getCell(7, 0), z:UIStage.LAYER2 + 2)
        //        addItem(x: 5, line: 2, item: KnightMaster())
    }
...
class SealersRoom:SingleRoom {
    ...
    override func create() {
        super.create()
        addSingleCellItem(x: 4, line: 2.25, texture: Game.instance.pictureAll.getCell(4, 4), z:UIStage.LAYER2 + 2)
        let shadow = SKTexture(imageNamed: "select.png").getCell(3, 0)
...
//        inode.position.x = cellSize * 0.5
//        shadow.position.x = inode.position.x
        setTexture(Game.instance.pictureNature.getCell(1, 0))
    }
...
class BurglarsRoom:SingleRoom {
    ...
    override func create() {
        super.create()
        addSingleCellItem(x: 4, line: 2.25, texture: Game.instance.pictureActor1.getCell(1, 4), z:UIStage.LAYER2 + 2)
...
class MonksRoom:SingleRoom {
    ...
    override func create() {
        super.create()
        addSingleCellItem(x: 4, line: 2.25, texture: Game.instance.pictureAll.getCell(4, 0), z:UIStage.LAYER2 + 2)
        //        addSingleCellItem(x: 4, line: 2.25, texture: Data.instance.pictureAll.getCell(4, 4), z:UIStage.LAYER2 + 2)
//        let shadow = SKTexture(imageNamed: "select.png").getCell(3, 0)
//        addSingleCellItem(x: 5, line: 1.95, texture: shadow)
        //        //        addSingleCellItem(x: 5, line: 2.25, texture: Data.instance.pictureNature.getCell(1, 0), z:UIStage.LAYER2 + 2)
...
class Apprentice:UIItem {
    override init(texture: SKTexture?, color: UIColor, size: CGSize) {
        super.init(texture: texture, color: color, size: size)
        setTexture(Game.instance.picturePeople1.getCell(10, 0))
    }
