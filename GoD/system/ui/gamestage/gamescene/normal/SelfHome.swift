...
class SelfHome: InnerHouse {
    ...
    override func create() {
        ...
        addItem(x: 0, y: 1, item: bed, z: MyScene.MAP_LAYER_Z)
...
//        addItem(x: 1, y: 6, item: ib.getNode(9, 15))
        addItem(x: 7, y: 0, item: ib.getNode(2, 7, 2, 2), z: MyScene.MAP_LAYER_Z)
        addItem(x: 3.5, y: -1.5, item: ib.getNode(12, 4, 2, 1), z: MyScene.ITEM_LAYER_Z)
        let wife = UIRole()
