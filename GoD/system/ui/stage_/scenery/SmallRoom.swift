...
//        let inside_a5 = Game.instance.inside_a5
...
//        let item = Game.instance.inside_b.getCell(0, 3, 1, 2)
//        setTexture(item)
//        xSize = 1
//        ySize = 2
...
//    override init(texture: SKTexture?, color: UIColor, size: CGSize) {
//        super.init(texture: texture, color: color, size: size)
//        let item = Game.instance.inside_b.getCell(4, 11, 1, 2)
//        setTexture(item)
//        xSize = 1
//        ySize = 2
...
//    override init(texture: SKTexture?, color: UIColor, size: CGSize) {
//        super.init(texture: texture, color: color, size: size)
//        let item = Game.instance.inside_b.getCell(0, 13, 1, 2)
//        setTexture(item)
//        xSize = 1
//        ySize = 2
//        _matrix = [[Block.IMPASSABLE],[Block.IMPASSABLE]]
...
//    override init(texture: SKTexture?, color: UIColor, size: CGSize) {
//        super.init(texture: texture, color: color, size: size)
//        let item = Game.instance.inside_b.getCell(9, 15)
//        setTexture(item)
...
//    override init(texture: SKTexture?, color: UIColor, size: CGSize) {
//        super.init(texture: texture, color: color, size: size)
//        let item = Game.instance.inside_b.getCell(seed(max: 6).toFloat(), 9, 1, 2)
//        setTexture(item)
//        xSize = 1
//        ySize = 2
