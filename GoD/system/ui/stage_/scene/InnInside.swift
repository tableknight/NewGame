...
class InnInside: UIScene {
    ...
    override func create() {
        ...
        addSingleCellItem(x: 11, line: 2.75, texture: Game.instance.pictureBaldo.getCell(10, 0), z: UIStage.LAYER2 - 1)
        addSingleCellItem(x: 13, line: 2.75, texture: Game.instance.pictureEvil.getCell(1, 0), z: UIStage.LAYER2 - 1)
        addSingleCellItem(x: 16, line: 2.75, texture: Game.instance.pictureEvil.getCell(7, 0), z: UIStage.LAYER2 - 1)
        addSingleCellItem(x: 19, line: 2.75, texture: Game.instance.pictureEvil.getCell(10, 4), z: UIStage.LAYER2 - 1)
...
//                        char._event.append(3)
                ...
                let img = Game.instance.pictureEvil.getCell(10, 4)
                let _ = stage.showDialog(img: img, text: "南无。。。", name: "阿三")
