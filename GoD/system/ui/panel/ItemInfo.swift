...
//        let bg = SKShapeNode(rect: CGRect(origin: CGPoint(x: 0, y: -_displayHeight), size: CGSize(width: cellSize * 3, height: _displayHeight)), cornerRadius: 4 )
